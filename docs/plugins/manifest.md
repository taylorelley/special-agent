...
read_when:
  - You are building a Special Agent plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (special-agent.plugin.json)

Every plugin **must** ship a `special-agent.plugin.json` file in the **plugin root**.
Special Agent uses this manifest to validate configuration **without executing plugin
