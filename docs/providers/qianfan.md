---
summary: "Use Qianfan's unified API to access many models in Special Agent"
read_when:
...
3. Special Agent installed on your system
...
4. Copy the API key for use with Special Agent

## CLI setup

```bash
special-agent onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Special Agent Configuration](/gateway/configuration)
