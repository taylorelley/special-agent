...
You can point Special Agent at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Special Agent
...
- [Anthropic provider](/providers/anthropic) - Native Special Agent integration with Claude setup-token or API keys
