---
summary: "Use Qwen OAuth (free tier) in Special Agent"
read_when:
  - You want to use Qwen with Special Agent
...
If you already logged in with the Qwen Code CLI, Special Agent will sync credentials
