---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Special Agent"
read_when:
  - You want Xiaomi MiMo models in Special Agent
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Special Agent uses
