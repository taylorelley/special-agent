...
Special Agent defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Special Agent inspects the OS preference (macOS/Windows)
