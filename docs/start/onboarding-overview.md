---
summary: "Overview of Special Agent onboarding options and flows"
read_when:
...
Special Agent supports multiple onboarding paths depending on where the Gateway runs
...
- [`special-agent onboard` command](/cli/onboard)

## macOS app onboarding

Use the Special Agent app when you want a fully guided setup on macOS. Docs:
