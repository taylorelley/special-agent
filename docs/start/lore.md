---
summary: "Backstory and lore of Special Agent for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Special Agent Lore"
---

# The Lore of Special Agent ✈️📖
...
For a while, the lobster was called **Clawd**, living in a **Special Agent**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in **Special Agent**. But that name never quite rolled off the tongue either...

So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Special Agent**.
...
In the end, **Special Agent** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.special-agent/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around Special Agent. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then Special Agent): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "special-agent what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with special-agent."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @special-agent. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Special Agent" to promote pump-and-dump tokens.
...
Special Agent never quite rolled off the tongue. And so, at 4am GMT, the team gathered AGAIN.

**The Great Special Agent Migration** began.
...
**The Scammer Speedrun:** Crypto grifters launched a $SPECIAL_AGENT token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
...
**Clawd → Special Agent → Special Agent**
