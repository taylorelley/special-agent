---
summary: "First-run onboarding flow for Special Agent (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Special Agent">
...
<Step title="CLI">
  ...
  The app can install the global `special-agent` CLI via npm/pnpm so terminal
