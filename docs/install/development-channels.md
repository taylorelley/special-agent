...
Special Agent ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Special Agent also aligns
the install method:
...
When you switch channels with `special-agent update`, Special Agent also syncs plugin sources:
