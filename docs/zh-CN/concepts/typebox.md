...
- 生成的 Swift 模型：`apps/macos/Sources/SpecialAgentProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/special-agent/special-agent/main/dist/protocol.schema.json
