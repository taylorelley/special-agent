...
本指南总结了在 Special Agent 中开发 Pi 集成的合理工作流程。
...
状态存储在 Special Agent 状态目录下。默认为 `~/.special-agent`。如果设置了 `SPECIAL_AGENT_STATE_DIR`，则使用该目录。

要重置所有内容：

- `special-agent.json` 用于配置
...
- https://docs.special-agent.ai/testing
- https://docs.special-agent.ai/start/getting-started
