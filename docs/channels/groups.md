...
Special Agent treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Special Agent “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Special Agent can see that group and respond there.
...
Translation: allowlisted senders can trigger Special Agent by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@special-agent", "special-agent", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
