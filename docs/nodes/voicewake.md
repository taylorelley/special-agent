...
Special Agent treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.special-agent/settings/voicewake.json`

Shape:

```json
{ "triggers": ["special-agent", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
