...
declare global {
  interface Window {
    __SPECIAL_AGENT_ASSISTANT_NAME__?: string;
    __SPECIAL_AGENT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__SPECIAL_AGENT_ASSISTANT_NAME__,
    avatar: window.__SPECIAL_AGENT_ASSISTANT_AVATAR__,
  });
}
