...
const CORE_PACKAGE_NAMES = new Set(["special-agent"]);
...
export async function resolveSpecialAgentPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveSpecialAgentPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
