...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: SpecialAgentConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: SpecialAgentConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: SpecialAgentConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: SpecialAgentConfig): void {
    this.cache.clear();
    if (cfg) {
  ...
  private resetIfConfigChanged(cfg: SpecialAgentConfig): void {
