...
import {
  ...
  type SpecialAgentPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @special-agent/voice-call -> voice-call).
...
export function discoverSpecialAgentPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".special-agent", "extensions")];
