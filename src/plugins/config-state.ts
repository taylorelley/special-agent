...
export const normalizePluginsConfig = (
  config?: SpecialAgentConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: SpecialAgentConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SpecialAgentConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: SpecialAgentConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
