...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.SPECIAL_AGENT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SpecialAgentConfig): string {
...
export function listEnabledTelegramAccounts(cfg: SpecialAgentConfig): ResolvedTelegramAccount[] {
