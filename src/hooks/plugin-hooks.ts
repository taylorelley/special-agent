...
import type { SpecialAgentPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: SpecialAgentPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: SpecialAgentPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
