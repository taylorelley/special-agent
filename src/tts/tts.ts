...
export function resolveTtsConfig(cfg: SpecialAgentConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.SPECIAL_AGENT_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: SpecialAgentConfig): string | undefined {
