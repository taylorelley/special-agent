...
import type { SpecialAgentPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverSpecialAgentPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, SpecialAgentPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SPECIAL_AGENT_PLUGIN_CATALOG_PATHS", "SPECIAL_AGENT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SpecialAgentPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SpecialAgentPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SpecialAgentPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSpecialAgentPlugins({ workspaceDir: options.workspaceDir });
