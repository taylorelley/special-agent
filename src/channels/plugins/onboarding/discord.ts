...
function setDiscordDmPolicy(cfg: SpecialAgentConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setDiscordAllowFrom(cfg: SpecialAgentConfig, allowFrom: string[]): SpecialAgentConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
