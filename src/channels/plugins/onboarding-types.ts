...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: SpecialAgentConfig) => DmPolicy;
  setPolicy: (cfg: SpecialAgentConfig, policy: DmPolicy) => SpecialAgentConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: SpecialAgentConfig) => SpecialAgentConfig;
};
