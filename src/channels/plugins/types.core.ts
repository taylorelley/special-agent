...
export type ChannelAgentToolFactory = (params: { cfg?: SpecialAgentConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SpecialAgentConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: SpecialAgentConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: SpecialAgentConfig }) => boolean;
  supportsCards?: (params: { cfg: SpecialAgentConfig }) => boolean;
