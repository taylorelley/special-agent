...
export function listSlackAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: SpecialAgentConfig): string {
...
function mergeSlackAccountConfig(cfg: SpecialAgentConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: SpecialAgentConfig): ResolvedSlackAccount[] {
