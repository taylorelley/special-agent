...
function listConfiguredAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: SpecialAgentConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SpecialAgentConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: SpecialAgentConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: SpecialAgentConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SpecialAgentConfig): ResolvedWhatsAppAccount[] {
