...
function listConfiguredAgentIds(cfg: SpecialAgentConfig): string[] {
...
export function listAgentsForGateway(cfg: SpecialAgentConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SpecialAgentConfig): string {
...
function resolveSessionStoreAgentId(cfg: SpecialAgentConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: SpecialAgentConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: SpecialAgentConfig): GatewaySessionsDefaults {
