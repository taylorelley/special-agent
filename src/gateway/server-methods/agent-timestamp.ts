 ...
 *
 * @see https://github.com/special-agent/special-agent/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an SpecialAgentConfig.
 */
export function timestampOptsFromConfig(cfg: SpecialAgentConfig): TimestampInjectionOptions {
  return {
