...
export function listBindings(cfg: SpecialAgentConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: SpecialAgentConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SpecialAgentConfig) {
