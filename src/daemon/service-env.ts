...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.SPECIAL_AGENT_STATE_DIR;
  const configPath = env.SPECIAL_AGENT_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    SPECIAL_AGENT_PROFILE: profile,
    SPECIAL_AGENT_STATE_DIR: stateDir,
    SPECIAL_AGENT_CONFIG_PATH: configPath,
    SPECIAL_AGENT_GATEWAY_PORT: String(port),
    SPECIAL_AGENT_GATEWAY_TOKEN: token,
    SPECIAL_AGENT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    SPECIAL_AGENT_SYSTEMD_UNIT: systemdUnit,
    SPECIAL_AGENT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    SPECIAL_AGENT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    SPECIAL_AGENT_STATE_DIR: stateDir,
    SPECIAL_AGENT_CONFIG_PATH: configPath,
    SPECIAL_AGENT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    SPECIAL_AGENT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    SPECIAL_AGENT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    SPECIAL_AGENT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    SPECIAL_AGENT_LOG_PREFIX: "node",
    SPECIAL_AGENT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    SPECIAL_AGENT_SERVICE_KIND: NODE_SERVICE_KIND,
    SPECIAL_AGENT_SERVICE_VERSION: VERSION,
  };
}
