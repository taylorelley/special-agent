...
export function listSignalAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SpecialAgentConfig): string {
...
function mergeSignalAccountConfig(cfg: SpecialAgentConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SpecialAgentConfig): ResolvedSignalAccount[] {
