...
export function applyMinimaxProviderConfig(cfg: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyMinimaxConfig(cfg: SpecialAgentConfig): SpecialAgentConfig {
