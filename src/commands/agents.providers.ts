...
function resolveDefaultAccountId(cfg: SpecialAgentConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SpecialAgentConfig): boolean {
...
export function summarizeBindings(cfg: SpecialAgentConfig, bindings: AgentBinding[]): string[] {
