...
export function summarizeExistingConfig(config: SpecialAgentConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.special-agent.ai/gateway/remote",
    "https://docs.special-agent.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
