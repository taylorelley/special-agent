...
export function applyOpenAIProviderConfig(cfg: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyOpenAIConfig(cfg: SpecialAgentConfig): SpecialAgentConfig {
