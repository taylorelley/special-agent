...
export function applyOpencodeZenProviderConfig(cfg: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyOpencodeZenConfig(cfg: SpecialAgentConfig): SpecialAgentConfig {
