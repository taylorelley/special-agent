...
export const A2UI_PATH = "/__special-agent__/a2ui";

export const CANVAS_HOST_PATH = "/__special-agent__/canvas";

export const CANVAS_WS_PATH = "/__special-agent__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.specialAgentCanvasA2UIAction.postMessage(...)
  // - Android: window.specialAgentCanvasA2UIAction.postMessage(...)
  const handlerNames = ["specialAgentCanvasA2UIAction"];
  ...
  globalThis.SpecialAgent = globalThis.SpecialAgent ?? {};
  globalThis.SpecialAgent.postMessage = postToNode;
  globalThis.SpecialAgent.sendUserAction = sendUserAction;
  globalThis.specialAgentPostMessage = postToNode;
  globalThis.specialAgentSendUserAction = sendUserAction;
