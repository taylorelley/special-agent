...
export function listIMessageAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: SpecialAgentConfig): string {
...
export function listEnabledIMessageAccounts(cfg: SpecialAgentConfig): ResolvedIMessageAccount[] {
