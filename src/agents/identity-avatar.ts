...
function resolveAvatarSource(cfg: SpecialAgentConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SpecialAgentConfig, agentId: string): AgentAvatarResolution {
