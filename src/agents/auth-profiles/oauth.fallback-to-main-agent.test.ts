...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveSpecialAgentAgentDir() returns mainAgentDir
    process.env.SPECIAL_AGENT_STATE_DIR = tmpDir;
    process.env.SPECIAL_AGENT_AGENT_DIR = mainAgentDir;
