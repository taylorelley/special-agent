import type { SpecialAgentConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: SpecialAgentConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: SpecialAgentConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[special-agent]";
}
