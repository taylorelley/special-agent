...
// pi-ai's built-in Anthropic catalog can lag behind SpecialAgent's defaults/docs.
...
export function buildModelAliasLines(cfg?: SpecialAgentConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveSpecialAgentAgentDir();
