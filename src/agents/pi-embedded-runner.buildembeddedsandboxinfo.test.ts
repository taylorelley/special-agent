...
const _ensureModels = (cfg: SpecialAgentConfig, agentDir: string) =>
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/special-agent-sandbox",
      agentWorkspaceDir: "/tmp/special-agent-workspace",
      ...
      browser: {
        ...
        containerName: "special-agent-sbx-browser-test",
      },
