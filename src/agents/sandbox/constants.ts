...
// Setting memorySwap equal to memory intentionally disables Docker swap.
// Per Docker --memory-swap semantics, when --memory-swap equals --memory,
// the container gets zero swap. This is a security/resource-hardening measure.
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "special-agent-sandbox-browser:bookworm-slim";
