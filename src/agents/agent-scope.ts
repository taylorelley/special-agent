...
type AgentEntry = NonNullable<NonNullable<SpecialAgentConfig["agents"]>["list"]>[number];
...
function listAgents(cfg: SpecialAgentConfig): AgentEntry[] {
...
export function listAgentIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultAgentId(cfg: SpecialAgentConfig): string {
  const agents = listAgents(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: SpecialAgentConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentWorkspaceDir(cfg: SpecialAgentConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: SpecialAgentConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
