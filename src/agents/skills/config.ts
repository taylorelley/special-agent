...
import type { SpecialAgentConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: SpecialAgentConfig | undefined, pathStr: string) {
...
const BUNDLED_SOURCES = new Set(["special-agent-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: SpecialAgentConfig): string[] | undefined {
