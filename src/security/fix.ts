...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SpecialAgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SpecialAgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: SpecialAgentConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
