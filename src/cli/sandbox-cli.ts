...
const SANDBOX_EXAMPLES = {
  main: [
    ["special-agent sandbox list", "List all sandbox containers."],
    ...
    ["special-agent sandbox recreate --agent mybot", "Recreate agent containers."],
    ["special-agent sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["special-agent sandbox list", "List all sandbox containers."],
    ["special-agent sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["special-agent sandbox explain", "Show effective sandbox config."],
    ["special-agent sandbox explain --session agent:main:main", "Explain a specific session."],
    ["special-agent sandbox explain --agent work", "Explain an agent sandbox."],
    ["special-agent sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.special-agent.ai/cli/sandbox")}\n`,
    )
    .action(() => {
