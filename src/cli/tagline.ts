const DEFAULT_TAGLINE = "All your chats, one SpecialAgent.";
...
const TAGLINES: string[] = [
  ...
  "The only crab in your contacts you actually want to hear from. ✈️",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.SPECIAL_AGENT_TAGLINE_INDEX;
