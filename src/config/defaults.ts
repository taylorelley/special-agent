...
function resolveAnthropicDefaultAuthMode(cfg: SpecialAgentConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyTalkApiKey(config: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyModelDefaults(cfg: SpecialAgentConfig): SpecialAgentConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyLoggingDefaults(cfg: SpecialAgentConfig): SpecialAgentConfig {
...
export function applyContextPruningDefaults(cfg: SpecialAgentConfig): SpecialAgentConfig {
