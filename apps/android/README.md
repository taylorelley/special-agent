## Special Agent Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_special-agent-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm special-agent gateway --port 18789 --verbose
```
