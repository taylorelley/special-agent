...
@MainActor
public struct SpecialAgentChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: SpecialAgentChatViewModel
    ...
    public init(
        viewModel: SpecialAgentChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                SpecialAgentChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [SpecialAgentChatMessage] {
        let base: [SpecialAgentChatMessage]
    ...
    private func mergeToolResults(in messages: [SpecialAgentChatMessage]) -> [SpecialAgentChatMessage] {
        ...
        for message in messages {
            ...
            let merged = SpecialAgentChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: SpecialAgentChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: SpecialAgentChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: SpecialAgentChatMessage) -> String {
