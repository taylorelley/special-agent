...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.special-agent", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.special-agent", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SpecialAgentProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
