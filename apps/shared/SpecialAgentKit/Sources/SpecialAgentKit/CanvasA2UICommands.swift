...
public enum SpecialAgentCanvasA2UICommand: String, Codable, Sendable {
...
public struct SpecialAgentCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SpecialAgentCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
