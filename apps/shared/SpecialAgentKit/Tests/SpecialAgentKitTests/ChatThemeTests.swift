...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = SpecialAgentChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = SpecialAgentChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
