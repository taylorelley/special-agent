...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SpecialAgentProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SpecialAgentProtocol.AnyCodable("start"),
                "name": SpecialAgentProtocol.AnyCodable("bash"),
            ],
            summary: nil)
