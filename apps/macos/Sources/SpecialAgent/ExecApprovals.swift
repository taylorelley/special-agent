...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.special-agent", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SpecialAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SpecialAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
