...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.special-agent", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SpecialAgentConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - SpecialAgent Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.special-agent/special-agent.json
