...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.special-agent", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SpecialAgent windows, but below the system’s pop-up menus.
