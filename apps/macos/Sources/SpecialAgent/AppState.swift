...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = SpecialAgentConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = SpecialAgentConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = SpecialAgentConfigFile.loadDict()
            ...
            SpecialAgentConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/special-agent"
        state.remoteCliPath = ""
        return state
    }
}
