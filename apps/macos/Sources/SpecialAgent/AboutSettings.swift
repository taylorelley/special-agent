...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/special-agent/special-agent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/special-agent/special-agent")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://special-agent.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "SpecialAgentBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "SpecialAgentBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SpecialAgentGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SpecialAgentGitCommit") as? String) ??
            "unknown"
    }
