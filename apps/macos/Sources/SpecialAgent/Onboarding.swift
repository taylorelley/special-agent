...
enum UIStrings {
    static let welcomeTitle = "Welcome to SpecialAgent"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "special-agent.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: SpecialAgentOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: SpecialAgentChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g special-agent@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SpecialAgentChatViewModel(
