...
enum SpecialAgentConfigFile {
    private static let logger = Logger(subsystem: "ai.special-agent", category: "config")
    ...
    static func stateDirURL() -> URL {
        SpecialAgentPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SpecialAgentPaths.workspaceURL
    }
