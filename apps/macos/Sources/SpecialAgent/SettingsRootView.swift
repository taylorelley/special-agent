...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .specialAgentSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SpecialAgentPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SpecialAgentPaths.stateDirURL.path
...
extension Notification.Name {
    static let specialAgentSelectSettingsTab = Notification.Name("specialAgentSelectSettingsTab")
}
