...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.special-agent", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SpecialAgent/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__special-agent__/a2ui/").absoluteString + "?platform=macos"
    }
