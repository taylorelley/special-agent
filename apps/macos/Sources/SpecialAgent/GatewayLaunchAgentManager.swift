...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.special-agent", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".special-agent/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.specialAgentCommand(
            subcommand: "gateway",
