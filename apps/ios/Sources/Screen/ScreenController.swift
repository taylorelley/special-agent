...
final class ScreenController {
    ...
    /// Callback invoked when an special-agent:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = SpecialAgentKitResources.bundle
...
/// Handles navigation policy to intercept special-agent:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept special-agent:// deep links.
        if url.scheme?.lowercased() == "special-agent" {
