...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SpecialAgentPhotosLatestParams) async throws -> SpecialAgentPhotosLatestPayload {
        ...
        var results: [SpecialAgentPhotoPayload] = []
        ...
        return SpecialAgentPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SpecialAgentPhotoPayload
    {
        ...
        return SpecialAgentPhotoPayload(
            format: "jpeg",
