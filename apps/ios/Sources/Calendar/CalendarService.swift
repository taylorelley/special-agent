...
final class CalendarService: CalendarServicing {
    func events(params: SpecialAgentCalendarEventsParams) async throws -> SpecialAgentCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            SpecialAgentCalendarEventPayload(
        ...
        return SpecialAgentCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: SpecialAgentCalendarAddParams) async throws -> SpecialAgentCalendarAddPayload {
        ...
        let payload = SpecialAgentCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return SpecialAgentCalendarAddPayload(event: payload)
    }
