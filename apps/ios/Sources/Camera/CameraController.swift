...
actor CameraController {
    ...
    func snap(params: SpecialAgentCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: SpecialAgentCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("special-agent-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("special-agent-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: SpecialAgentCameraFacing,
