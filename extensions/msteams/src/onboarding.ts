...
function setMSTeamsDmPolicy(cfg: SpecialAgentConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: SpecialAgentConfig, allowFrom: string[]): SpecialAgentConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
