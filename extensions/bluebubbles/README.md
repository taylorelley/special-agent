...
This directory contains the **BlueBubbles external channel plugin** for Special Agent.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `special-agent/plugin-sdk` helpers.
