...
export function listBlueBubblesAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: SpecialAgentConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: SpecialAgentConfig): ResolvedBlueBubblesAccount[] {
