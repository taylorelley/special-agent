...
Nostr DM channel plugin for Special Agent using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Special Agent. It enables your bot to:
...
# Configure special-agent to use local relay
