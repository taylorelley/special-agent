...
export function listZalouserAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: SpecialAgentConfig): string {
...
function mergeZalouserAccountConfig(cfg: SpecialAgentConfig, accountId: string): ZalouserAccountConfig {
