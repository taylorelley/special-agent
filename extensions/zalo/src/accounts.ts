...
export function listZaloAccountIds(cfg: SpecialAgentConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: SpecialAgentConfig): string {
...
function mergeZaloAccountConfig(cfg: SpecialAgentConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SpecialAgentConfig): ResolvedZaloAccount[] {
