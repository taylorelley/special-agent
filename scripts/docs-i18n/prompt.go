...
- Keep product names in English: Special Agent, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Special Agent Gateway, use “Gateway 网关”.
