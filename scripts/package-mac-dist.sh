...
#
# Output:
# - dist/SpecialAgent.app
# - dist/Special Agent-<version>.zip
# - dist/Special Agent-<version>.dmg
...
APP="$ROOT_DIR/dist/SpecialAgent.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Special Agent-$VERSION.zip"
DMG="$ROOT_DIR/dist/Special Agent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Special Agent-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Special Agent-$VERSION.dSYM.zip"
