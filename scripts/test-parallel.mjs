...
const shardOverride = Number.parseInt(process.env.SPECIAL_AGENT_TEST_SHARDS ?? "", 10);
...
const overrideWorkers = Number.parseInt(process.env.SPECIAL_AGENT_TEST_WORKERS ?? "", 10);
