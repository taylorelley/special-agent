...
if [[ -z "$version_content" ]]; then
  echo "<h2>Special Agent $VERSION</h2>"
  echo "<p>Latest Special Agent update.</p>"
  echo "<p><a href=\"https://github.com/special-agent/special-agent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
